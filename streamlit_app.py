...
def convert_docx_to_pdf_libreoffice(docx_bytes):
    """
    Convert .docx to .pdf using LibreOffice (free, works on Streamlit Cloud).
    Returns PDF bytes.
    """
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            raise Exception("LibreOffice not found. Please ensure it's installed.")
    ...
    if submitted:
        ...
        try:
            with st.spinner("🔄 Generating your PDF..."):
                ...
                # Convert to PDF using LibreOffice (free!)
                pdf_bytes = convert_docx_to_pdf_libreoffice(docx_bytes)
            ...
            st.info("💡 Tip: Make sure LibreOffice is installed on your system.")
